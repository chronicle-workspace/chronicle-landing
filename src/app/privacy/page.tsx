  ...
  return (
    <div className="max-w-4xl mx-auto py-8">
      ...
      <section className="mb-8">
        ...
        <p>
          &quot;Chronicle&quot;는 원칙적으로 사용자의 개인정보를 제3자에게
          제공하지 않습니다. 서비스 향상을 위해 필요한 경우 및 법적 의무 이행을
          위해 제한적으로 개인정보를 제3자에게 제공할 수 있습니다. 이 경우
          사전에 사용자의 동의를 얻습니다.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          &quot;Chronicle&quot;는 사용자의 개인정보를 안전하게 처리하기 위해
          개인정보 암호화, 접근 권한 관리 및 접근 통제, 보안 프로그램 설치 및
          주기적인 갱신·점검 등의 대책을 시행합니다.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-2">
          ...
          수 있는 권리를 가집니다. 이러한 권리는 &quot;Chronicle&quot;의 고객
          서비스 담당 부서에 서면, 전화, 이메일 등을 통해 요청함으로써 행사할 수
          있습니다. &quot;Chronicle&quot;는 사용자의 개인정보를 보호하고,
          사용자가 안심하고 서비스를 이용할 수 있도록 최선을 다하고 있습니다.
          사용자의 개인정보와 관련된 모든 문의사항에 대하여 신속하고 충실하게
          답변할 준비가 되어 있습니다.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          &quot;Chronicle&quot;의 공지사항을 통해 사전에 알릴 예정입니다. 이러한
          변경에는 개인정보 수집 항목의 추가, 처리 목적의 변경, 개인정보의 제3자
          제공 관련 사항 변경 등이 포함될 수 있습니다.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          본 개인정보 처리방침은 &quot;Chronicle&quot;에서 제공하는 모든
          서비스에 적용되며, &quot;Chronicle&quot;이 운영하는 모든 웹사이트,
          모바일 애플리케이션 및 기타 플랫폼을 포함합니다. 그러나
          &quot;Chronicle&quot; 외부로 링크된 사이트에서는 본 개인정보
          처리방침이 적용되지 않습니다.
        </p>
      </section>
